...
window.TEXTS = {
  kk: {
    ...
    // главная
    home_title: "Жеке есептеу құралдарының (ЖЕҚ/ЖҮҚ) көрсеткіштерін қабылдау және өңдеуге арналған бірыңғай автоматтандырылған платформа.",
    home_desc:  "",

    // страница "Көрсеткіш жіберу"
    send_title: "Көрсеткіш жіберу",
    send_desc:  "Алдымен елді мекенді таңдаңыз, содан кейін лицевой шот пен қызмет түрін көрсетіңіз.",
